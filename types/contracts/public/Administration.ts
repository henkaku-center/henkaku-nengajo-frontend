...
export interface AdministrationInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "addAdmins" | "deleteAdmin" | "isAdmin"
  ): FunctionFragment;
...
export interface Administration extends BaseContract {
