...
export interface NengajoInterface extends utils.Interface {
  functions: {
    ...
    "calcPrice(uint256)": FunctionFragment;
    ...
    "retrieveRegisteredCount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "retrieveRegisteredCount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Nengajo extends BaseContract {
  ...
  functions: {
    ...
    retrieveRegisteredCount(overrides?: CallOverrides): Promise<[BigNumber]>;
